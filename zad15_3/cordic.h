...
#define half_pi 0x6487ED51 // połowa pi w formi ustalonej liczby bitów
#define MUL 1073741824.000000 // mnożnik 
#define CORDIC_NTAB 64 // liczba elementów w tablicy
...
// tablica zawierająca preobliczone wartości arctangensów dla kolejnych iteracji algorytmu CORDIC 
...
/*
Funkcja cordic, która implementuje algorytm CORDIC.
Zmienne lokalne: k (iteracja), d (znak), tx, ty, tz (tymczasowe zmienne).
Początkowe wartości x, y, z są ustawione na cordic_1K, 0, i theta.
Pętla wykonuje algorytm CORDIC dla określonej liczby iteracji (n).
Wewnętrzna instrukcja warunkowa sprawdza znak (d) przy użyciu przesunięcia bitowego.
Aktualizacja wartości x, y, z na podstawie wyników iteracji.
Wyniki (x i y) są zwracane przez wskaźniki s i c.
 */